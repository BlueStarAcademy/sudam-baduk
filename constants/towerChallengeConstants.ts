...
const rawData = [
    ...
    { floor: 8, ap: 2, board: 7, bTarget: 12, wTarget: 5, ai: 60, bLimit: 15, bStones: 3, wStones: 7, bPattern: 3, wP: 2, fcReward: '골드100', fcExp: 20, rcReward: '골드10', rcExp: 10 },
    { floor: 9, ap: 2, board: 7, bTarget: 13, wTarget: 5, ai: 60, bLimit: 15, bStones: 3, wStones: 6, bPattern: 3, wP: 3, fcReward: '골드100', fcExp: 20, rcReward: '골드10', rcExp: 10 },
    { floor: 10, ap: 2, board: 7, bTarget: 15, wTarget: 5, ai: 60, bLimit: 20, bStones: 4, wStones: 7, bPattern: 2, wP: 3, fcReward: '장비상자1', fcExp: 100, rcReward: '골드15', rcExp: 10 },
    { floor: 11, ap: 2, board: 9, bTarget: 15, wTarget: 5, ai: 60, bLimit: 20, bStones: 3, wStones: 13, bP: 0, wP: 0, fcReward: '골드150', fcExp: 20, rcReward: '골드10', rcExp: 10 },
    { floor: 12, ap: 2, board: 9, bTarget: 16, wTarget: 5, ai: 60, bLimit: 20, bStones: 4, wStones: 14, bP: 0, wP: 1, fcReward: '골드150', fcExp: 20, rcReward: '골드10', rcExp: 10 },
    { floor: 13, ap: 2, board: 9, bTarget: 17, wTarget: 5, ai: 60, bLimit: 20, bStones: 5, wStones: 15, bP: 1, wP: 1, fcReward: '골드150', fcExp: 20, rcReward: '골드10', rcExp: 10 },
    { floor: 14, ap: 2, board: 9, bTarget: 18, wTarget: 5, ai: 60, bLimit: 20, bStones: 4, wStones: 15, bP: 2, wP: 1, fcReward: '골드150', fcExp: 20, rcReward: '골드10', rcExp: 10 },
    { floor: 15, ap: 2, board: 9, bTarget: 19, wTarget: 5, ai: 60, bLimit: 20, bStones: 3, wStones: 14, bP: 2, wP: 1, fcReward: '재료상자1', fcExp: 50, rcReward: '골드10', rcExp: 10 },
    { floor: 16, ap: 2, board: 9, bTarget: 20, wTarget: 5, ai: 60, bLimit: 22, bStones: 2, wStones: 13, bP: 2, wP: 0, fcReward: '골드150', fcExp: 30, rcReward: '골드15', rcExp: 10 },
    { floor: 17, ap: 2, board: 9, bTarget: 21, wTarget: 5, ai: 60, bLimit: 24, bStones: 3, wStones: 15, bP: 2, wP: 2, fcReward: '골드150', fcExp: 30, rcReward: '골드15', rcExp: 10 },
    { floor: 18, ap: 2, board: 9, bTarget: 22, wTarget: 5, ai: 60, bLimit: 26, bStones: 4, wStones: 16, bP: 3, wP: 2, fcReward: '골드150', fcExp: 30, rcReward: '골드15', rcExp: 10 },
    { floor: 19, ap: 2, board: 9, bTarget: 23, wTarget: 5, ai: 60, bLimit: 28, bStones: 5, wStones: 17, bP: 3, wP: 3, fcReward: '골드150', fcExp: 30, rcReward: '골드15', rcExp: 10 },
    { floor: 20, ap: 2, board: 9, bTarget: 25, wTarget: 5, ai: 60, bLimit: 30, bStones: 5, wStones: 18, bP: 2, wP: 3, fcReward: '다이아꾸러미1', fcExp: 30, rcReward: '골드15', rcExp: 10 },

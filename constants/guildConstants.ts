...
export const GUILD_RESEARCH_PROJECTS: Record<GuildResearchId, GuildResearchProject> = {
    [GuildResearchId.member_limit_increase]: { image: '/images/guild/lab/guildskill.png', category: 'development', name: '길드원 확장', description: '길드 최대 인원 수를 증가시킵니다.', maxLevel: 7, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '명', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(7) },
    ...
    [GuildResearchId.boss_skill_heal_block]: { image: '/images/guild/lab/bosslab2.png', category: 'boss', name: '길드보스전 [회복 불가]', description: '일정 확률로 보스의 회복을 막거나 회복량을 감소시킵니다.', maxLevel: 7, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(7) },
    [GuildResearchId.boss_skill_regen]: { image: '/images/guild/lab/bosslab3.png', category: 'boss', name: '길드보스전 [회복]', description: '일정 확률로 자신의 체력을 지속적으로 회복합니다.', maxLevel: 7, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(7) },
    [GuildResearchId.boss_skill_ignite]: { image: '/images/guild/lab/bosslab4.png', category: 'boss', name: '길드보스전 [점화]', description: '일정 확률로 보스에게 지속적인 점화 피해를 입힙니다.', maxLevel: 7, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(7) },
    ...
    [GuildResearchId.stat_concentration]: { image: '/images/guild/lab/statlab1.png', category: 'stats', name: '집중력 증가', description: '모든 길드원의 집중력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_thinking_speed]: { image: '/images/guild/lab/statlab2.png', category: 'stats', name: '사고속도 증가', description: '모든 길드원의 사고속도 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_judgment]: { image: '/images/guild/lab/statlab3.png', category: 'stats', name: '판단력 증가', description: '모든 길드원의 판단력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_calculation]: { image: '/images/guild/lab/statlab4.png', category: 'stats', name: '계산력 증가', description: '모든 길드원의 계산력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_combat_power]: { image: '/images/guild/lab/statlab5.png', category: 'stats', name: '전투력 증가', description: '모든 길드원의 전투력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_stability]: { image: '/images/guild/lab/statlab6.png', category: 'stats', name: '안정감 증가', description: '모든 길드원의 안정감 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },

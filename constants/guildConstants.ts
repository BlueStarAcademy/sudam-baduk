...
import { GuildMemberRole, GuildMission, GuildResearchId, GuildResearchCategory, ItemGrade, GuildResearchProject, GuildBossInfo, CoreStat, GuildBossSkill } from '../types/index.js';
...
export const GUILD_INITIAL_MEMBER_LIMIT = 20;
...
export const GUILD_MISSIONS_POOL: Omit<GuildMission, 'id' | 'progress' | 'isCompleted' | 'claimedBy'>[] = [
    { title: '길드 출석 50회', description: '길드원들이 총 50회 출석하기', target: 50, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'checkIns' },
    { title: '전략바둑 50승', description: '길드원들이 전략바둑에서 총 50승 거두기', target: 50, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'strategicWins' },
    { title: '놀이바둑 50승', description: '길드원들이 놀이바둑에서 총 50승 거두기', target: 50, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'playfulWins' },
    { title: '다이아 1000개 소비', description: '길드원들이 상점 등에서 다이아 총 1000개 소비하기', target: 1000, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'diamondsSpent' },
    { title: '장비 강화 30회', description: '길드원들이 장비 강화 총 30회 시도하기', target: 30, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'equipmentEnhancements' },
    { title: '재료 제작 30회', description: '길드원들이 재료 제작(합성/분해) 총 30회 시도하기', target: 30, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'materialCrafts' },
    { title: '장비 합성 5회 (에픽 이상)', description: '길드원들이 에픽 등급 이상 장비 합성 5회 성공하기', target: 5, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'equipmentSyntheses' },
    { title: '챔피언십 보상 5회 수령', description: '길드원들이 챔피언십 보상 총 5회 수령하기', target: 5, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'championshipClaims' },
    { title: '길드 보스전 30회 참여', description: '길드원들이 길드 보스전에 총 30회 참여하기', target: 30, personalReward: { guildCoins: 100 }, guildReward: { guildXp: 3000 }, progressKey: 'bossAttempts' },
];
...
export const GUILD_RESEARCH_PROJECTS: Record<GuildResearchId, GuildResearchProject> = {
    [GuildResearchId.member_limit_increase]: { image: '/images/guild/lab/guildskill.png', category: 'development', name: '길드원 확장', description: '길드 최대 인원 수를 증가시킵니다.', maxLevel: 4, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '명', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(4) },
    [GuildResearchId.boss_hp_increase]: { image: '/images/guild/lab/bosslab1.png', category: 'boss', name: '길드보스전 HP 증가', description: '길드 보스전에서 유저의 최대 체력을 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.boss_skill_heal_block]: { image: '/images/guild/lab/bosslab2.png', category: 'boss', name: '길드보스전 [회복 불가]', description: '일정 확률로 보스의 회복을 막거나 회복량을 감소시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.boss_skill_regen]: { image: '/images/guild/lab/bosslab3.png', category: 'boss', name: '길드보스전 [회복]', description: '일정 확률로 자신의 체력을 지속적으로 회복합니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.boss_skill_ignite]: { image: '/images/guild/lab/bosslab4.png', category: 'boss', name: '길드보스전 [점화]', description: '일정 확률로 보스에게 지속적인 점화 피해를 입힙니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.ap_regen_boost]: { image: '/images/guild/lab/statlab7.png', category: 'stats', name: '행동력 회복속도 증가', description: '모든 길드원의 행동력 회복 속도를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_concentration]: { image: '/images/guild/lab/statlab1.png', category: 'stats', name: '집중력 증가', description: '모든 길드원의 집중력 능력치를 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.stat_thinking_speed]: { image: '/images/guild/lab/statlab2.png', category: 'stats', name: '사고속도 증가', description: '모든 길드원의 사고속도 능력치를 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.stat_judgment]: { image: '/images/guild/lab/statlab3.png', category: 'stats', name: '판단력 증가', description: '모든 길드원의 판단력 능력치를 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.stat_calculation]: { image: '/images/guild/lab/statlab4.png', category: 'stats', name: '계산력 증가', description: '모든 길드원의 계산력 능력치를 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.stat_combat_power]: { image: '/images/guild/lab/statlab5.png', category: 'stats', name: '전투력 증가', description: '모든 길드원의 전투력 능력치를 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.stat_stability]: { image: '/images/guild/lab/statlab6.png', category: 'stats', name: '안정감 증가', description: '모든 길드원의 안정감 능력치를 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_strategic_gold]: { image: '/images/guild/lab/gamelab1.png', category: 'rewards', name: '전략 바둑 골드보상 증가', description: '모든 길드원의 전략 바둑 골드 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_playful_gold]: { image: '/images/guild/lab/gamelab2.png', category: 'rewards', name: '놀이 바둑 골드보상 증가', description: '모든 길드원의 놀이 바둑 골드 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_strategic_xp]: { image: '/images/guild/lab/gamelab3.png', category: 'rewards', name: '전략 바둑 경험치보상 증가', description: '모든 길드원의 전략 바둑 경험치 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_playful_xp]: { image: '/images/guild/lab/gamelab4.png', category: 'rewards', name: '놀이 바둑 경험치보상 증가', description: '모든 길드원의 놀이 바둑 경험치 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
};

...
export const SINGLE_PLAYER_STAGES: SinglePlayerStageInfo[] = [
    ...
    ...[
        ...
        gameType: 'capture',
        mode: gameTypeToModeMap['capture'],
        timeControl: byoyomiTimeControl,
        actionPointCost: 2,
        boardSize: 7,
        ...
        placements: {
            ...d.placements,
            randomBlackStones: parsed_random_placement_data[d.id]?.randomBlackStones || 0,
            randomWhiteStones: parsed_random_placement_data[d.id]?.randomWhiteStones || 0,
            randomBlackPatternedStones: parsed_random_placement_data[d.id]?.randomBlackPatternedStones || 0,
            randomWhitePatternedStones: parsed_random_placement_data[d.id]?.randomWhitePatternedStones || 0,
        }
    })),
    ...
    ...[
        ...
        level: SinglePlayerLevel.입문,
        gameType: 'survival',
        mode: gameTypeToModeMap['survival'],
        timeControl: byoyomiTimeControl,
        actionPointCost: 2,
        boardSize: 9,
        targetScore: { black: d.bTarget, white: d.wTarget },
        whiteStoneLimit: d.wLimit,
        placements: {
            ...d.placements,
            randomBlackStones: parsed_random_placement_data[d.id]?.randomBlackStones || 0,
            randomWhiteStones: parsed_random_placement_data[d.id]?.randomWhiteStones || 0,
    ...
    ...[
        ...
        gameType: 'speed',
        mode: gameTypeToModeMap['speed'],
        actionPointCost: 3,
        boardSize: 9,
        autoEndTurnCount: 40,
        timeControl: fischerTimeControl,
        placements: {
            ...d.placements,
            randomBlackStones: parsed_random_placement_data[d.id]?.randomBlackStones || 0,
            randomWhiteStones: parsed_random_placement_data[d.id]?.randomWhiteStones || 0,
    ...
    ...[
        ...
        gameType: 'missile',
        mode: gameTypeToModeMap['missile'],
    ...
    ...[
        ...
        ...d,
        name: `스테이지 ${d.id.split('-')[1]}`,
        level: SinglePlayerLevel.고급,
        gameType: 'hidden',
        mode: gameTypeToModeMap['hidden'],
        hiddenStoneCount: 1,
        scanCount: 5,
        actionPointCost: 5,
        boardSize: 13,

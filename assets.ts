...
// Guild Boss UI Icons
export const GUILD_BOSS_COIN_IMG = "/images/guild/guild_boss_token.png";
export const BOSS_ATTACK_ICON = "/images/icons/boss_attack_icon.png";
export const BOSS_SKILL_ICON = "/images/icons/boss_skill_icon.png";
export const USER_ATTACK_ICON = "/images/icons/user_attack_icon.png";
export const USER_SKILL_ICON = "/images/icons/user_skill_icon.png";
export const HEAL_ICON = "/images/icons/heal_icon.png";
export const GUILD_ATTACK_ICON = "/images/guild/attack.png";

// Guild Research Skill Icons
export const GUILD_RESEARCH_HEAL_BLOCK_IMG = '/images/guild/lab/bosslab2.png';
export const GUILD_RESEARCH_REGEN_IMG = '/images/guild/lab/bosslab3.png';
export const GUILD_RESEARCH_IGNITE_IMG = '/images/guild/lab/bosslab4.png';

// Single Player Pattern Stones
export const BLACK_PATTERN_STONE_IMG = "/images/single/BlackDouble.png";
export const WHITE_PATTERN_STONE_IMG = "/images/single/WhiteDouble.png";
...
export const ALL_IMAGE_URLS = [
    ...
    BLACK_PATTERN_STONE_IMG,
    WHITE_PATTERN_STONE_IMG,
];
...
export const BOSS_SKILL_ICON_MAP: Record<string, string> = {
    ...
    '녹수_자연의치유': BOSS_SKILL_IMG_3_1,
    '녹수_숲의압박': BOSS_SKILL_IMG_3_2,
    '녹수_포자확산': BOSS_SKILL_IMG_3_3,

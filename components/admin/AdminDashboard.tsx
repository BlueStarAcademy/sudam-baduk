        ...
        <div className="bg-primary text-primary">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                <div onClick={() => onNavigate('userManagement')} className="bg-blue-800/50 hover:bg-blue-700/50 p-6 rounded-lg shadow-lg cursor-pointer transition-all transform hover:-translate-y-1 border border-color">
                 ...
                 <div onClick={() => onNavigate('guildManagement')} className="bg-purple-800/50 hover:bg-purple-700/50 p-6 rounded-lg shadow-lg cursor-pointer transition-all transform hover:-translate-y-1 border border-color">
                    <h2 className="text-2xl font-bold text-purple-300">길드 관리</h2>
                    <p className="mt-2 text-gray-400">길드 정보 수정, 제재, 해체 등 길드 관련 기능을 관리합니다.</p>
                </div>
                <div onClick={() => onNavigate('mailSystem')} className="bg-green-800/50 hover:bg-green-700/50 p-6 rounded-lg shadow-lg cursor-pointer transition-all transform hover:-translate-y-1 border border-color">
                    ...
                    <p className="mt-2 text-gray-400">전체, 특정 사용자 또는 길드에게 재화와 메시지를 보냅니다.</p>
                </div>

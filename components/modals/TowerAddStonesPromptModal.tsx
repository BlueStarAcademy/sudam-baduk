...
const TowerAddStonesPromptModal: React.FC<TowerAddStonesPromptModalProps> = ({ session, onAction }) => {
    // The cost for adding stones is in Gold, not Diamonds.
    const costs = [300, 500, 1000];
    const cost = costs[session.towerAddStonesUsed || 0];
    ...
    return (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
            <div className="bg-primary border-2 border-color rounded-lg shadow-xl p-6 w-full max-w-md text-center animate-fade-in">
                ...
                <p className="text-secondary mb-4">흑돌을 모두 사용했습니다. 골드 {cost}개를 사용하여 착수 3회를 추가하시겠습니까?</p>
                ...
                <div className="flex gap-4">
                    ...
                    {/* FIX: Changed diamond icon to gold icon. */}

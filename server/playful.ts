...
import { handleSharedAction, updateSharedGameState, handleTimeoutFoul } from './modes/shared.js';
import { initializeAlkkagi, updateAlkkagiState, handleAlkkagiAction } from './modes/alkkagi.js';
import { initializeCurling, updateCurlingState, handleCurlingAction } from './modes/curling.js';
import { initializeDiceGo, updateDiceGoState, handleDiceGoAction } from './modes/diceGo.js';
import { initializeOmok, updateOmokState, handleOmokAction } from './modes/omok.js';
import { initializeThief, updateThiefState, handleThiefAction } from './modes/thief.js';

...
export const rowToUser = (row: any): User | null => {
    ...
    try {
        ...
        const user: User = {
            ...
            isAdmin: !!row.isAdmin,
            strategyLevel: row.strategyLevel != null ? Number(row.strategyLevel) : 1,
            strategyXp: row.strategyXp != null ? Number(row.strategyXp) : 0,
            playfulLevel: row.playfulLevel != null ? Number(row.playfulLevel) : 1,
            ...
            actionPointPurchasesToday: row.actionPointPurchasesToday != null ? Number(row.actionPointPurchasesToday) : 0,
            lastActionPointPurchaseDate: row.lastActionPointPurchaseDate != null ? Number(row.lastActionPointPurchaseDate) : 0,
            actionPointQuizzesToday: row.actionPointQuizzesToday != null ? Number(row.actionPointQuizzesToday) : 0,
            ...
            tournamentScore: row.tournamentScore != null ? Number(row.tournamentScore) : 0,
            league: row.league || LeagueTier.Sprout,
            mannerMasteryApplied: !!row.mannerMasteryApplied,
            mannerScore: row.mannerScore != null ? Number(row.mannerScore) : 200,
            ...
            guildCoins: row.guildCoins != null ? Number(row.guildCoins) : 0,
            guildBossAttempts: row.guildBossAttempts != null ? Number(row.guildBossAttempts) : 0,
...
export const rowToGame = (row: any): LiveGameSession | null => {
    ...
    try {
        ...
        const game: LiveGameSession = {
            ...
            passCount: row.passCount != null ? Number(row.passCount) : 0,
            ...
            blackTimeLeft: row.blackTimeLeft != null ? Number(row.blackTimeLeft) : 0,
            whiteTimeLeft: row.whiteTimeLeft != null ? Number(row.whiteTimeLeft) : 0,
            blackByoyomiPeriodsLeft: row.blackByoyomiPeriodsLeft != null ? Number(row.blackByoyomiPeriodsLeft) : 0,
            whiteByoyomiPeriodsLeft: row.whiteByoyomiPeriodsLeft != null ? Number(row.whiteByoyomiPeriodsLeft) : 0,
            turnDeadline: row.turnDeadline != null ? Number(row.turnDeadline) : undefined,
            turnStartTime: row.turnStartTime != null ? Number(row.turnStartTime) : undefined,
            ...
            basePlacementDeadline: row.basePlacementDeadline != null ? Number(row.basePlacementDeadline) : undefined,
            komiBids: ensureObject(safeParse(row.komiBids, undefined), undefined),
            komiBiddingDeadline: row.komiBiddingDeadline != null ? Number(row.komiBiddingDeadline) : undefined,
            komiBiddingRound: row.komiBiddingRound ?? undefined,
            komiBidRevealProcessed: !!row.komiBidRevealProcessed,
            finalKomi: row.finalKomi != null ? Number(row.finalKomi) : undefined,
            ...
            turnOrderRollDeadline: row.turnOrderRollDeadline != null ? Number(row.turnOrderRollDeadline) : undefined,
            turnOrderAnimationEndTime: row.turnOrderAnimationEndTime != null ? Number(row.turnOrderAnimationEndTime) : undefined,
            turnChoiceDeadline: row.turnChoiceDeadline != null ? Number(row.turnChoiceDeadline) : undefined,
            ...
            alkkagiTurnDeadline: row.alkkagiTurnDeadline != null ? Number(row.alkkagiTurnDeadline) : undefined,
            alkkagiPlacementDeadline: row.alkkagiPlacementDeadline != null ? Number(row.alkkagiPlacementDeadline) : undefined,
            ...
            curlingTurnDeadline: row.curlingTurnDeadline != null ? Number(row.curlingTurnDeadline) : undefined,
            ...
            pausedTurnTimeLeft: row.pausedTurnTimeLeft != null ? Number(row.pausedTurnTimeLeft) : undefined,
            itemUseDeadline: row.itemUseDeadline != null ? Number(row.itemUseDeadline) : undefined,
            lastTimeoutPlayerId: row.lastTimeoutPlayerId ?? undefined,
            lastTimeoutPlayerIdClearTime: row.lastTimeoutPlayerIdClearTime != null ? Number(row.lastTimeoutPlayerIdClearTime) : undefined,
            revealAnimationEndTime: row.revealAnimationEndTime != null ? Number(row.revealAnimationEndTime) : undefined,
            ...
            singlePlayerPlacementRefreshesUsed: row.singlePlayerPlacementRefreshesUsed != null ? Number(row.singlePlayerPlacementRefreshesUsed) : 0,
            towerChallengePlacementRefreshesUsed: row.towerChallengePlacementRefreshesUsed != null ? Number(row.towerChallengePlacementRefreshesUsed) : 0,
            towerAddStonesUsed: row.towerAddStonesUsed != null ? Number(row.towerAddStonesUsed) : 0,
